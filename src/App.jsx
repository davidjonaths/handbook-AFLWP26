...
import logo from './assets/euphorewa.png'
    ...
    <main className="quiz-shell">
      <header className="topbar">
        <button className="brand" onClick={restart} aria-label="Back to start">
          <img src={logo} alt="Euphorewa logo" className="brand-logo" />
...
function Results({ score, onRestart }) {
  ...
  return (
    <main className="results-page">
      <nav className="welcome-nav"><div className="brand"><img src={logo} alt="Euphorewa logo" className="brand-logo" /><span>AIESEC <strong>in USU</strong></span></div><button className="restart-link" onClick={onRestart}><RotateCcw size={16} /> Play again</button></nav>
